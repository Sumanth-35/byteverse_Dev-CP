...
const CropRecommendation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const options = {
        ...
        body: JSON.stringify({
          nitrogen,phosphorous,potassium,ph,temperature,rainfall,humidity,state,district
        })
      }
    ...
    try {
      const res = await fetch(
        'https://byte-verse-default-rtdb.firebaseio.com/UserData.json',
        options
      )
      console.log(res);
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      {prediction && (
          <div data-aos="fade-up" className="p-2 w-full md:max-w-lg bg-[#cdf1c7] shadow-md rounded px-8 pt-6 pb-8 mb-4">
